...
\begin{center}
    \textbf{\Huge \scshape {{ heading.name }} } \\ \vspace{1pt}
    \small {{ heading.phone }} $|$ \href{mailto:{{ heading.email }}}{\underline{{ '{' ~ heading.email ~ '}' }}} $|$ 
    \href{https://{{ heading.linkedin }}}{\underline{{ '{' ~ heading.linkedin ~ '}' }}} $|$
    \href{https://{{ heading.github }}}{\underline{{ '{' ~ heading.github ~ '}' }}}
\end{center}
